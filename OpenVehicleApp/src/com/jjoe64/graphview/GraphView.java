...
abstract public class GraphView extends LinearLayout {
	...
	private class GraphViewContentView extends View {
		...
		protected void onDraw(Canvas canvas) {
			...
			if(customDraw != null)
				customDraw.MyDraw(canvas, paint, graphheight, border);
		}
		...
		public boolean onTouchEvent(MotionEvent event) {
			...
			if (mtouchEvent != null) {
				boolean handled = mtouchEvent.onTouchEvent(event);
				if (handled) {
					return handled;
				}
			}
...
//	private final View viewVerLabels;
	private final VerLabelsView viewVerLabels;
	public float getGraphWidth()
	{ return graphViewContentView.graphwidth;}
	...
	/**
	 * set a custom TouchEvent
	 * @param TouchEvent
	 */
	public void setTouchEvent(TouchEvent touchEvent) {
		graphViewContentView.setTouchEvent(touchEvent);
	}
	/**
