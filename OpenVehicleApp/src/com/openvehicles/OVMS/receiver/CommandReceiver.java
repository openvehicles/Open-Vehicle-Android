...
public abstract class CommandReceiver extends BroadcastReceiver {
	...
	public void sendCommand(int pResIdMessage, String pCommand) {
		...
		Log.i(TAG, "sendCommand: " + pCommand);
	}
	
	public void sendCommand(String pMessage, String pCommand) {
		if (mContext == null || TextUtils.isEmpty(pCommand)) return;
		
		int separatorIndex = pCommand.indexOf(',');
		mExpectedCmd = separatorIndex > 0 ? pCommand.substring(0, separatorIndex) : pCommand; 
