...
public class CarData implements Serializable {
  ...
  public int       car_direction = 0;                                   // Data_Direction
  public int       car_altitude = 0;                                    // Data_Altitude
  public String    car_speed = "";
  public String    car_tripmeter = "";
  public String    car_odometer = "";
  public boolean   car_gpslock = false;                                 // Data_GPSLocked
  public DataStale stale_gps = DataStale.NoValue;                                 // Data_GPSDataStale
  ...
  public DataStale stale_tpms = DataStale.NoValue;				// Data_TPMSDataStale
  ...
  public int car_charge_state_i_raw = 0;				// Data_ChargeState_raw
  public int car_charge_substate_i_raw = 0;				// Data_ChargeSubstate
  public String car_mode_s_raw = "";
  public int car_mode_i_raw = 0;					// Data_ChargeMode_raw
  public int car_range_ideal_raw = 0;
  public int car_range_estimated_raw = 0;
  public int car_charge_currentlimit_raw = 0;				// Data_ChargeAmpsLimit
  public int car_charge_duration_raw = 0;				// ??
  public int car_charge_b4byte_raw = 0;					// Data_ChargerB4State
  public int car_charge_kwhconsumed = 0;				// Data_ChargerKWHConsumed
  ...
  public int car_stale_gps_raw = -1;					// Data_GPSDataStale
